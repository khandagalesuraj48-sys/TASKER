  ...
  return (
    <>
      <div
        ...
        className={cn(
          'group relative rounded-xl border border-border bg-card text-card-foreground p-3.5 sm:p-4 transition-all shadow-xs hover:shadow-md hover:border-primary/40',
