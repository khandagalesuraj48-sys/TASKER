      ...
      return (
        <div className="text-center space-y-6 animate-in fade-in-50 slide-in-from-right-5">
          ...
          <button
            onClick={onClose}
            className={cn(
              "w-full bg-primary text-primary-foreground font-medium py-3 px-6 rounded-xl cursor-pointer",
              "hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-primary/20"
            )}
          >
            Get Started
    ...
    return (
      <div className="space-y-4 animate-in fade-in-50 slide-in-from-right-5">
        ...
        <button
          ...
          disabled={isLoading}
          className={cn(
            "w-full relative bg-primary text-primary-foreground font-medium py-3 px-6 rounded-xl transition-all cursor-pointer",
            "hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-primary/20",
            "disabled:opacity-50"
          )}
        >
      ...
      {authMode !== 'reset' && (
        <div className="flex bg-muted rounded-xl p-1 mb-6">
          <button
            onClick={() => setAuthMode('login')}
            className={cn(
              "flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all cursor-pointer",
              authMode === 'login'
